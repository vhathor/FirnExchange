/*==============================================================================
  ...
  Prerequisites:
    ...
    - FirnExchange.py and pyproject.toml files in the specified directory
...
PUT file:///Users/vverma/sprojects/FirnExchange/FirnExchange.py 
    @FT_DB.FT_SCH.FIRNEXCHANGE_STAGE 
    AUTO_COMPRESS = FALSE 
    OVERWRITE = TRUE;

-- Upload Python dependencies file
PUT file:///Users/vverma/sprojects/FirnExchange/pyproject.toml 
    @FT_DB.FT_SCH.FIRNEXCHANGE_STAGE 
    AUTO_COMPRESS = FALSE 
    OVERWRITE = TRUE;
